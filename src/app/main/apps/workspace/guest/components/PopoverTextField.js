...
const PopoverTextField = (props) => {
	...
	useEffect(() => {
		setInputContent(props.data[props.title].content)
	}, [props.data[props.title].content])
	...
	return (
		<>
			...
			<div
				ref={divRef}
				onMouseEnter={!questionIsEmpty ? onOpenCommentBox : null}
				onMouseLeave={!questionIsEmpty ? onCloseCommentBox : null}
				style={{
					width: `${fullWidth}`,
				}}
			>
