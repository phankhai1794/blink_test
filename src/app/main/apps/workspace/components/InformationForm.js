    ...
    >
      ...
      {isHover && (
        <>
          ...
          <div style={{ marginLeft: '1rem', width: '48px', height: '48px' }}></div>
        </>
      )}
    </div>
  );
  ...
  return (
    <div className="flex" key={id}>
      ...
      <TextField
        ...
        InputProps={{ classes }}
      />
      <IconButton style={{ marginLeft: '1rem' }} onClick={() => handleRemoveChoice(id)}>
        <CloseIcon />
      </IconButton>
    </div>
  );
  ...
  return (
    <div style={{ padding: '4rem 5.5rem' }}>
          ...
          <div style={{ paddingTop: '2rem' }}>
            ...
            {questionInfo.addOther && (
              <div className="flex">
                ...
                />
                <IconButton style={{ marginLeft: '1rem' }} onClick={handleRemoveOtherChoice}>
                  <CloseIcon />
                </IconButton>
              </div>
            )}
      ...
      <div className="flex justify-between pt-1">
        <Link style={{ fontSize: '20px' }} onClick={toggleDrawer}>
          Open All Inquiries
        </Link>
        <div>
          <ArrowBackIosIcon />
