  ...
  return (
    <>
      <Popover
        ...
        PaperProps={{
          onMouseEnter: questionIsEmpty ? onOpenCommentButton : onOpenCommentBox,
          onMouseLeave: onCloseCommentButton
        }}
      >
        <IconButton color="primary" onClick={onOpenCommentBox}>
        ...
        <TextField
          ...
          InputProps={{
            style: {
              fontFamily: 'Courier New',
              backgroundColor: `${
                openCmtBtn !== openCmtBox ? 'yellow' : `${open ? 'yellow' : '#f5f8fa'}`
              }`
            },
            endAdornment: (
