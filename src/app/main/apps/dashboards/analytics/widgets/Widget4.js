      ...
      <div className="p-16 pb-0 flex flex-row items-end flex-wrap">
        ...
        <div className="py-4 text-16 flex flex-row items-center">
          <div className="flex flex-row items-center">
            {props.data.visits.ofTarget > 0 && <Icon className="text-green mr-4">trending_up</Icon>}
            {props.data.visits.ofTarget < 0 && <Icon className="text-red mr-4">trending_down</Icon>}
