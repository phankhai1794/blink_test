...
const BookingFooter = (props) => {
    ...
    const currentBookingForm = useSelector(({ exportApp }) => exportApp.booking.form);
...
export default withReducer('exportApp', reducers)(withRouter(BookingFooter));
