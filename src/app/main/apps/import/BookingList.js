...
function BookingsList(props) {
    ...
    const bookings = useSelector(({ importApp }) => importApp.bookings.data);
    const selectedBookingIds = useSelector(({ importApp }) => importApp.bookings.selectedBookingIds);
    const searchText = useSelector(({ importApp }) => importApp.bookings.searchText);
