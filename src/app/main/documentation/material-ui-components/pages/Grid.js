      ...
      content={
        <div className="p-24 max-w-2xl">
          ...
          <Typography className="mb-16" component="div">
            The <a href="https://material.io/design/layout/responsive-layout-grid.html">grid</a>{' '}
            creates visual consistency between layouts while allowing flexibility across a wide
          ...
          <Typography className="mb-16" component="div">
            If you are <strong>new to or unfamiliar with flexbox</strong>, we encourage you to read
            this{' '}
          ...
          <Typography className="mb-16" component="div">
            ...
            The spacing property is an integer between 0 and 10 inclusive. By default, the spacing
            between two grid items follows a linear function:{' '}
          ...
          <Typography className="mb-16" component="div">
            ...
            means you can set the width of one <em>item</em> and the others will automatically
            resize around it.
          </Typography>
          <Typography className="mb-16" component="div">
            <FuseExample
          ...
          <Typography className="mb-16" component="div">
            The <code>{`container`}</code> and <code>{`item`}</code> properties are two independent
            booleans. They can be combined.
          </Typography>
          <blockquote>
            <Typography className="mb-16" component="div">
              A flex <strong>container</strong> is the box generated by an element with a computed
              display of <code>{`flex`}</code> or <code>{`inline-flex`}</code>. In-flow children of
              a flex container are called flex <strong>items</strong> and are laid out using the
              flex layout model.
            </Typography>
          </blockquote>
          <Typography className="mb-16" component="div">
          ...
          <ol>
            ...
            <li>
              Applying padding to the parent with at least half the spacing value applied to the
              child:
...
`}
          ...
          <Typography className="mb-16" component="div">
            The initial setting on flex items is <code>{`min-width: auto`}</code>. It&#39;s causing
            a positioning conflict when the children is using <code>{`white-space: nowrap;`}</code>.
...
`}
          ...
          <Typography className="mb-16" component="div">
            ...
            <code>{`zeroMinWidth`}</code> property:
          </Typography>
...
`}
          ...
          <Typography className="mb-16" component="div">
            Though the <code>{`Grid`}</code> component has a <code>{`direction`}</code> property
            that allows values of <code>{`row`}</code>, <code>{`row-reverse`}</code>,{' '}
            <code>{`column`}</code>, and <code>{`column-reverse`}</code>, there are some features
            that are not supported within <code>{`column`}</code> and{' '}
            <code>{`column-reverse`}</code> containers. The properties which define the number of
            grids the component will use for a given breakpoint (<code>{`xs`}</code>,{' '}
            <code>{`sm`}</code>, <code>{`md`}</code>, <code>{`lg`}</code>, and <code>{`xl`}</code>)
            are focused on controlling width and do <strong>not</strong> have similar effects on
            height within <code>{`column`}</code> and <code>{`column-reverse`}</code> containers. If
            used within <code>{`column`}</code> or <code>{`column-reverse`}</code> containers, these
            properties may have undesirable effects on the width of the <code>{`Grid`}</code>{' '}
            elements.
          </Typography>
          <Typography className="text-32 mt-32 mb-8" component="h2">
            CSS Grid Layout
          ...
          <Typography className="mb-16" component="div">
            Material-UI doesn&#39;t provide any CSS Grid functionality itself, but as seen below you
            can easily use CSS Grid to layout your pages.
          </Typography>
          <Typography className="mb-16" component="div">
            <FuseExample
              className="my-24"
