      ...
      content={
        <div className="p-24 max-w-2xl">
          ...
          <Typography className="mb-16" component="div">
            ...
            <em>background image</em> to display the media. It can be problematic in some
            situations. For instance, you might want to display a video or a responsive image. Use
            the <code>{`component`}</code> property for these use cases:
          </Typography>
          <Typography className="mb-16" component="div">
            <FuseExample
              className="my-24"
          ...
          <blockquote>
            <Typography className="mb-16" component="div">
              ...
              <code>{`object-fit`}</code> for centering the image. It&#39;s not supported by IE 11.
            </Typography>
          </blockquote>
          <Typography className="text-32 mt-32 mb-8" component="h2">
            UI Controls
