      ...
      content={
        <div className="p-24 max-w-2xl">
          ...
          <Typography className="mb-16" component="div">
            When activated,{' '}
            <a href="https://material.io/design/components/tooltips.html">Tooltips</a> display a
          ...
          <Typography className="mb-16" component="div">
            ...
            custom React element, you need to make sure that it spreads its properties to the
...
`}
          ...
          <Typography className="mb-16" component="div">
            ...
            interactions so a <code>{`Tooltip`}</code> will not activate on normal events like
            hover. To accommodate disabled elements, add a simple wrapper element like a{' '}
            <code>{`span`}</code>.
          </Typography>
          <Typography className="mb-16" component="div">
            <FuseExample
          ...
          <Typography className="mb-16" component="div">
            ...
            hiding the tooltip can be added through the properties <code>{`enterDelay`}</code> and{' '}
          ...
          <Typography className="mb-16" component="div">
            ...
            <code>{`disableTouchListener`}</code> property.
          </Typography>
          <Typography className="mb-16" component="div">
            <FuseExample
              className="my-24"
