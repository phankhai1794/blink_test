      ...
      content={
        <div className="p-24 max-w-2xl">
          ...
          <Typography className="mb-16" component="div">
            ...
            it&#39;s illustrated in the previous demo, you can use it to defer the rendering from
            the server to the client.
          </Typography>
          <Typography className="mb-16" component="div">
            But you can also use it to defer the rendering within the client itself. You can{' '}
            <strong>wait a screen frame</strong> with the <code>{`defer`}</code> property to render
            the children. React does{' '}
