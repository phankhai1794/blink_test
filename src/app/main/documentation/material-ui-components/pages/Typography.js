    ...
    <FusePageSimple
      ...
      content={
        <div className="p-24 max-w-2xl">
          ...
          <Typography className="mb-16" component="div">
            The <em>Roboto</em> font will <strong>not</strong> be automatically loaded by
            Material-UI. The developer is responsible for loading all fonts used in their
            application. Roboto Font has a few easy ways to get started. For more advanced
...
`}
          ...
          <Typography className="mb-16" component="div">
            You can <a href="https://www.npmjs.com/package/typeface-roboto">install it</a> by typing
            the below command in your terminal:
          </Typography>
          <Typography className="mb-16" component="div">
            <code>{`npm install typeface-roboto --save`}</code>
          </Typography>
          <Typography className="mb-16" component="div">
...
`}
          ...
          <Typography className="mb-16" component="div">
            ⚠️ Be careful when using this approach. Make sure your bundler doesn&#39;t eager load
            all the font variations (100/300/400/500/700/900, italic/regular, SVG/woff). Inlining
            all the font files can significantly increase the size of your bundle. Material-UI
          ...
          <Typography className="mb-16" component="div">
            In some situations you might not be able to use the <code>{`Typography`}</code>{' '}
            component. Hopefully, you might be able to take advantage of the{' '}
            <a href="/customization/default-theme/?expend-path=$.typography">
          ...
          <Typography className="mb-16" component="div">
            The Typography component uses the <code>{`variantMapping`}</code> property to associate
            a UI variant with a semantic element. It’s important to realize that the style of a
            typography is independent from the semantic underlying element.
          </Typography>
          <ul>
            <li>
              You can change the underlying element for a one time occassion with the{' '}
