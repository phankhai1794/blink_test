      ...
      content={
        <div className="p-24 max-w-2xl">
          ...
          <Typography className="mb-16" component="div">
            ...
            they can display avatars, icons, clarifying subtext, or orthogonal actions (such as
            adding an account).
          </Typography>
          <Typography className="mb-16" component="div">
            Touch mechanics:
          ...
          <ul>
            ...
            <li>
              Touching outside of the dialog, or pressing Back, cancels the action and closes the
              dialog
            </li>
          </ul>
          <Typography className="mb-16" component="div">
          ...
          <Typography className="mb-16" component="div">
            Most alerts don&#39;t need titles. They summarize a decision in a sentence or two by
            either:
          </Typography>
          <ul>
          ...
          <Typography className="mb-16" component="div">
            ...
            connectivity. Users should be able to understand the choices based on the title and
            button text alone.
          </Typography>
          <Typography className="mb-16" component="div">
          ...
          <Typography className="mb-16" component="div">
            Form dialogs allow users to fill out form fields within a dialog. For example, if your
            site prompts for potential subscribers to fill in their email address, they can fill out
          ...
          <Typography className="mb-16" component="div">
            ...
            combination with the <code>{`fullWidth`}</code> boolean. When the{' '}
            <code>{`fullWidth`}</code> property is true, the dialog will adapt based on the{' '}
          ...
          <Typography className="mb-16" component="div">
            You may make a dialog responsively full screen using <code>{`withMobileDialog`}</code>.
            By default, <code>{`withMobileDialog()(Dialog)`}</code> responsively full screens{' '}
            <em>at or below</em> the <code>{`sm`}</code>{' '}
            <a href="/customization/breakpoints/">screen size</a>. You can choose your own
            breakpoint for example <code>{`xs`}</code> by passing the <code>{`breakpoint`}</code>{' '}
            argument: <code>{`withMobileDialog({breakpoint: &#39;xs&#39;})(Dialog)`}</code>.
          </Typography>
          <Typography className="mb-16" component="div">
            <FuseExample
              className="my-24"
          ...
          <Typography className="mb-16" component="div">
            ...
            is committed. For example, users can listen to multiple ringtones but only make a final
          ...
          <ul>
            ...
            <li>
              <code>{`scroll=body`}</code> the content of the dialog scrolls within the body
              element.
            </li>
          </ul>
          <Typography className="mb-16" component="div">
          ...
          <Typography className="mb-16" component="div">
            ...
            <a href="https://github.com/mzabriskie/react-draggable">react-draggable</a>. To do so,
            you can pass the the imported <code>{`Draggable`}</code> component as the{' '}
            <code>{`PaperComponent`}</code> of the <code>{`Dialog`}</code> component. This will make
            the entire dialog draggable.
          </Typography>
          <Typography className="mb-16" component="div">
            <FuseExample
              className="my-24"
