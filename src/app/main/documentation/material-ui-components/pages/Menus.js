      ...
      content={
        <div className="p-24 max-w-2xl">
          ...
          <Typography className="mb-16" component="div">
            ...
            choices on a temporary surface. It appears when the user interacts with a button, or
            other control.
          </Typography>
          ...
          <Typography className="mb-16" component="div">
            Simple menus open over the anchor element by default (this option can be changed via
            props). When close to a screen edge, simple menus vertically realign to make sure that
            all menu items are completely visible.
          </Typography>
          <Typography className="mb-16" component="div">
          ...
          <Typography className="mb-16" component="div">
            ...
            additional detail related to the options available for a list item or provide
            navigational or orthogonal actions related to the primary task. Although they can
            display the same content, simple menus are preferred over simple dialogs because simple
            menus are less disruptive to the user’s current context.
          </Typography>
          <Typography className="mb-16" component="div">
            <FuseExample
              className="my-24"
          ...
          <Typography className="mb-16" component="div">
            ...
            currently selected menu item with the anchor element, and the initial focus will be
            placed on the selected menu item. The currently selected menu item is set using the{' '}
            <code>{`selected`}</code> property (from <a href="/api/list-item/">ListItem</a>). To use
            a selected menu item without impacting the initial focus or the vertical positioning of
            the menu, set the <code>{`variant`}</code> property to <code>{`menu`}</code>.
          </Typography>
          <Typography className="mb-16" component="div">
            <FuseExample
              className="my-24"
          ...
          <Typography className="mb-16" component="div">
            ...
            internally. However, you might want to use a different positioning strategy, or not
            blocking the scroll. For answering those needs, we expose a <code>{`MenuList`}</code>{' '}
            component that you can compose, with <code>{`Popper`}</code> in this example.
          </Typography>
          <Typography className="mb-16" component="div">
          ...
          <Typography className="mb-16" component="div">
            The <code>{`MenuItem`}</code> is a wrapper around <code>{`ListItem`}</code> with some
            additional styles. You can use the same list composition features with the{' '}
            <code>{`MenuItem`}</code> component:
          </Typography>
          <Typography className="text-32 mt-32 mb-8" component="h2">
            Max height menus
          </Typography>
          <Typography className="mb-16" component="div">
            If the height of a menu prevents all menu items from being displayed, the menu can
            scroll internally.
          </Typography>
          <Typography className="mb-16" component="div">
            <FuseExample
          ...
          <Typography className="mb-16" component="div">
            ...
            that prevents <code>{`text-overflow: ellipsis`}</code> from working in a flexbox layout.
            You can use the <code>{`Typography`}</code> component with <code>{`noWrap`}</code> to
