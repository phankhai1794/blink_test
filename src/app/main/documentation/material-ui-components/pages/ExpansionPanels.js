      ...
      content={
        <div className="p-24 max-w-2xl">
          ...
          <Typography className="mb-16" component="div">
            ...
            is a lightweight container that may either stand alone or be connected to a larger
            surface, such as a card.
          </Typography>
          <blockquote>
            <Typography className="mb-16" component="div">
              <strong>Note:</strong> Expansion panels are no longer documented in the Material
          ...
          <Typography className="mb-16" component="div">
            ...
            <code>{`ExpansionPanelSummary`}</code>. The <code>{`ExpansionPanel`}</code> will derive
            the necessary <code>{`aria-labelledby`}</code>
            and <code>{`id`}</code> for the content region of the panel.
          </Typography>
          <Typography className="text-32 mt-32 mb-8" component="h2">
          ...
          <Typography className="mb-16" component="div">
            <FuseExample
              ...
              iframe={false}
              component={
                require('app/main/documentation/material-ui-components/components/expansion-panels/SimpleExpansionPanel.js')
                  .default
              }
          ...
          <Typography className="mb-16" component="div">
            <FuseExample
              ...
              iframe={false}
              component={
                require('app/main/documentation/material-ui-components/components/expansion-panels/ControlledExpansionPanels.js')
                  .default
              }
          ...
          <Typography className="mb-16" component="div">
            Multiple columns can be used to structure the content, and a helper text may be added to
            the panel to assist the user.
          </Typography>
          <Typography className="mb-16" component="div">
            <FuseExample
              className="my-24"
              iframe={false}
              component={
                require('app/main/documentation/material-ui-components/components/expansion-panels/DetailedExpansionPanel.js')
                  .default
              }
          ...
          <Typography className="mb-16" component="div">
            ...
            This default behavior has server-side rendering and SEO in mind. If you render expensive
            component trees inside your panels or simply render many panels it might be a good idea
            to change this default behavior by enabling the
            <code>{`unmountOnExit`}</code> in <code>{`TransitionProps`}</code>:{' '}
            <code>{`&lt;ExpansionPanel TransitionProps={{ unmountOnExit: true }} /&gt;`}</code>. As
            with any performance optimization this is not a silver bullet. Be sure to identify
          ...
          <Typography className="mb-16" component="div">
            <FuseExample
              ...
              iframe={false}
              component={
                require('app/main/documentation/material-ui-components/components/expansion-panels/CustomizedExpansionPanels.js')
                  .default
              }
