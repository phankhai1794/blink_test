      ...
      content={
        <div className="p-24 max-w-2xl">
          ...
          <Typography className="mb-16" component="div">
            Examples of badges containing text, using primary and secondary colors. The badge is
          ...
          <Typography className="mb-16" component="div">
            The <code>{`dot`}</code> property changes a badge into a small dot. This can be used as
