    ...
    <FusePageSimple
      ...
      content={
        <div className="p-24 max-w-2xl">
          ...
          <ul>
            <li>
              📦 <a href="/size-snapshot">1.4 kB gzipped</a>.
            </li>
          </ul>
          ...
          <Typography className="mb-16" component="div">
            For instance, if you need to hide a menu dropdown when people click anywhere else on
            your page:
          </Typography>
          <Typography className="mb-16" component="div">
            <FuseExample
          ...
          <Typography className="mb-16" component="div">
            You can find a more advanced demo on the{' '}
