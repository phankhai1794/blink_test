      ...
      content={
        <div className="p-24 max-w-2xl">
          ...
          <Typography className="mb-16" component="div">
            <a href="https://material.io/design/components/chips.html">Chips</a> allow users to
            enter information, make selections, filter content, or trigger actions.
          </Typography>
          <Typography className="mb-16" component="div">
            While included here as a standalone component, the most common use will be in some form
            of input, so some of the behaviour demonstrated here is not shown in context.
          </Typography>
          <Typography className="text-32 mt-32 mb-8" component="h2">
            Chip
          </Typography>
          <Typography className="mb-16" component="div">
            Examples of Chips, using an image Avatar, SVG Icon Avatar, &quot;Letter&quot; and
            (string) Avatar.
          </Typography>
          <ul>
            <li>
              Chips with the <code>{`onClick`}</code> property defined change appearance on focus,
              hover, and click.
            </li>
            <li>
              Chips with the <code>{`onDelete`}</code> property defined will display a delete icon
          ...
          <Typography className="mb-16" component="div">
            ...
            it from the array. Note that since no
            <code>{`onClick`}</code> property is defined, the Chip can be focused, but does not gain
            depth while clicked or touched.
          </Typography>
          <Typography className="mb-16" component="div">
            <FuseExample
              className="my-24"
