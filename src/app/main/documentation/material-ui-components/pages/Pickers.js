      ...
      content={
        <div className="p-24 max-w-2xl">
          ...
          <ul>
            ...
            <li>
              For inline display, such as on a form, consider using compact controls such as
          ...
          <Typography className="mb-16" component="div">
            ...
            the <a href="#complementary-projects">complementary projects</a> for a richer solution.
          </Typography>
          ...
          <Typography className="mb-16" component="div">
            <a href="https://material-ui-pickers.dev/">@material-ui/pickers</a> provides date and
            time controls that follow the Material Design spec.
          </Typography>
          <Typography className="mb-16" component="div">
            <FuseExample
              className="my-24"
