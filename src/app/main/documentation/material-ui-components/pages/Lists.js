      ...
      content={
        <div className="p-24 max-w-2xl">
          ...
          <Typography className="mb-16" component="div">
            <a href="https://material.io/design/components/lists.html">Lists</a> are a continuous
            group of text or images. They are composed of items containing primary and supplemental
...
`}
          ...
          <Typography className="mb-16" component="div">
            The checkbox is the primary action and the state indicator for the list item. The
            comment button is a secondary action and a separate target.
          </Typography>
          <Typography className="mb-16" component="div">
            <FuseExample
              className="my-24"
          ...
          <Typography className="mb-16" component="div">
            This feature is relying on the CSS sticky positioning. Unfortunately it&#39;s{' '}
            <a href="https://caniuse.com/#search=sticky">not implemented</a> by all the browsers we
            are supporting. We default to <code>{`disableSticky`}</code> when not supported.
          </Typography>
          <Typography className="mb-16" component="div">
            <FuseExample
              className="my-24"
          ...
          <Typography className="mb-16" component="div">
            ...
            <code>{`List`}</code> component. It renders 200 rows and can easily handle more.
          ...
          <Typography className="mb-16" component="div">
            ...
            <a href="https://github.com/bvaughn/react-window">react-window</a> when possible. If
