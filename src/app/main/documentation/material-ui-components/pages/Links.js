        ...
        <div className="p-24 max-w-2xl">
          ...
          <ul>
            ...
            <li>
              ...
              used as a child of a Typograpy component.
            </li>
          </ul>
          <Typography className="text-32 mt-32 mb-8" component="h2">
            Accessibility
          ...
          <ul>
            <li>
              ...
              access the window.opener property and ensures it runs in a separate process. Without
              this the target page can potentially redirect your page to a malicious URL.
            </li>
            <li>
              <code>{`rel=&quot;noreferrer&quot;&quot;`}</code> has the same effect, but also
              prevents the <em>Referer</em> header from being sent to the new page. ⚠️ Removing the
              referrer header will affect analytics.
            </li>
          </ul>
          <Typography className="text-32 mt-32 mb-8" component="h2">
          ...
          <Typography className="mb-16" component="div">
            One common use case is to perform the navigation on the client only, without doing a
            .html round-trip with the server. The <code>{`Link`}</code> component provides a
          ...
          <Typography className="mb-16" component="div">
            <FuseExample
              ...
              iframe={false}
              component={
                require('app/main/documentation/material-ui-components/components/links/LinkRouter.js')
                  .default
              }
          ...
          <Typography className="mb-16" component="div">
            <em>
              Note: Creating the Link components is necessary to prevent unexpected unmounting. You
