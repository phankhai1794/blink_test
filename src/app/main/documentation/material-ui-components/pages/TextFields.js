      ...
      content={
        <div className="p-24 max-w-2xl">
          ...
          <Typography className="mb-16" component="div">
            <a href="https://material.io/design/components/text-fields.html">Text fields</a> allow
            users to enter text into a UI. They typically appear in forms and dialogs.
          </Typography>
          <Typography className="text-32 mt-32 mb-8" component="h2">
            TextField
          </Typography>
          <Typography className="mb-16" component="div">
            The <code>{`TextField`}</code> wrapper component is a complete form control including a
          ...
          <Typography className="mb-16" component="div">
            <FuseExample
              ...
              iframe={false}
              component={
                require('app/main/documentation/material-ui-components/components/text-fields/TextFields.js')
                  .default
              }
          ...
          <blockquote>
            <Typography className="mb-16" component="div">
              <strong>Note:</strong> This version of the text field is no longer documented in the
          ...
          <Typography className="mb-16" component="div">
            <FuseExample
              ...
              iframe={false}
              component={
                require('app/main/documentation/material-ui-components/components/text-fields/OutlinedTextFields.js')
                  .default
              }
          ...
          <Typography className="mb-16" component="div">
            <FuseExample
              ...
              iframe={false}
              component={
                require('app/main/documentation/material-ui-components/components/text-fields/FilledTextFields.js')
                  .default
              }
          ...
          <Typography className="mb-16" component="div">
            ...
            <code>{`TextField`}</code> component. This is on purpose. The component takes care of
            the most used properties, then it&#39;s up to the user to use the underlying component
            shown in the following demo. Still, you can use <code>{`inputProps`}</code> (and{' '}
            <code>{`InputProps`}</code>, <code>{`InputLabelProps`}</code> properties) if you want to
          ...
          <Typography className="mb-16" component="div">
            Here are some examples of customizing the component. You can learn more about this in
            the
          ...
          <Typography className="mb-16" component="div">
            ...
            and give your app a unique feel. Below is an example using the{' '}
          ...
          <Typography className="mb-16" component="div">
            <code>{`Input`}</code> allows the provision of <code>{`InputAdornment`}</code>. These
            can be used to add a prefix, a suffix or an action to an input. For instance, you can
          ...
          <Typography className="mb-16" component="div">
            <FuseExample
              ...
              iframe={false}
              component={
                require('app/main/documentation/material-ui-components/components/text-fields/FilledInputAdornments.js')
                  .default
              }
          ...
          <Typography className="mb-16" component="div">
            <FuseExample
              ...
              iframe={false}
              component={
                require('app/main/documentation/material-ui-components/components/text-fields/OutlinedInputAdornments.js')
                  .default
              }
          ...
          <Typography className="mb-16" component="div">
            <code>{`TextField`}</code>, <code>{`FormControl`}</code> allow the specification of{' '}
            <code>{`margin`}</code> to alter the vertical spacing of inputs. Using
            <code>{`none`}</code> (default) will not apply margins to the{' '}
            <code>{`FormControl`}</code>, whereas <code>{`dense`}</code> and <code>{`normal`}</code>{' '}
          ...
          <Typography className="mb-16" component="div">
            <FuseExample
              ...
              iframe={false}
              component={
                require('app/main/documentation/material-ui-components/components/text-fields/TextFieldMargins.js')
                  .default
              }
          ...
          <Typography className="mb-16" component="div">
            ...
            supposed to shrink as soon as the input is displaying something. In some circumstances,
            we can&#39;t determine the &quot;shrink&quot; state (number input, datetime input,
            Stripe input). You might notice an overlap.
          </Typography>
          <Typography className="mb-16" component="div">
            {' '}
            src="/static/images/text-fields/shrink.png" alt="shrink/>
          </Typography>
          <Typography className="mb-16" component="div">
...
`}
          ...
          <Typography className="mb-16" component="div">
            ...
            implementation of the <code>{`&lt;input&gt;`}</code> element with the{' '}
            <code>{`inputComponent`}</code> property. The provided input component should handle the{' '}
            <code>{`inputRef`}</code> property. The property should be called with a value
            implementing the{' '}
          ...
          <Typography className="mb-16" component="div">
            ...
            <a href="https://github.com/s-yadav/react-number-format">react-number-format</a>{' '}
            libraries.
          </Typography>
          <Typography className="mb-16" component="div">
            <FuseExample
          ...
          <Typography className="mb-16" component="div">
            ...
            <strong>the input should be linked to the label and the helper text</strong>. The
            underlying DOM nodes should have this structure.
          </Typography>
...
`}
          ...
          <ul>
            <li>
              If you are using the <code>{`TextField`}</code> component, you just have to provide a
              unique <code>{`id`}</code>.
            </li>
...
`}
          ...
          <ul>
            ...
            <li>
              <a href="https://github.com/stackworx/formik-material-ui">formik-material-ui</a>{' '}
              Bindings for using Material-UI with formik.
            </li>
            <li>
              <a href="https://github.com/Deadly0/final-form-material-ui">final-form-material-ui</a>{' '}
