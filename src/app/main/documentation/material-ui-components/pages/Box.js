      ...
      content={
        <div className="p-24 max-w-2xl">
          ...
          <Typography className="mb-16" component="div">
            ...
            function of <code>{`@material-ui/styles`}</code>.
          </Typography>
          ...
          <Typography className="mb-16" component="div">
            ...
            <code>{`&lt;div&gt;`}</code> by default that can be changed with the{' '}
            <code>{`component`}</code> property. Let&#39;s say you want to use a{' '}
...
`}
          ...
          <Typography className="mb-16" component="div">
            This works great when the changes can be isolated to a new DOM element. For instance,
            you can change the margin this way.
          </Typography>
          <Typography className="mb-16" component="div">
            However, sometimes you have to target the underlying DOM element. For instance, you want
            to change the text color of the button. The Button component defines its own color. CSS
          ...
          <Typography className="mb-16" component="div">
            The Box component has a <code>{`clone`}</code> property to enable the usage of the clone
            element method of React.
          </Typography>
          ...
          <table>
            ...
            <tbody>
              ...
              <tr>
                ...
                <td align="left">
                  If <code>{`true`}</code>, the box will recycle its children DOM element. It&#39;s
