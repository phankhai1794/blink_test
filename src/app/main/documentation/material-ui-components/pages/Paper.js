      ...
      content={
        <div className="p-24 max-w-2xl">
          ...
          <Typography className="mb-16" component="div">
            ...
            and an application’s behavior mimics paper’s ability to be re-sized, shuffled, and bound
          ...
          <Typography className="mb-16" component="div">
            <FuseExample
              ...
              iframe={false}
              component={
                require('app/main/documentation/material-ui-components/components/paper/PaperSheet.js')
                  .default
              }
