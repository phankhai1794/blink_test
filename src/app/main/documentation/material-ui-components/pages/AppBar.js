      ...
      content={
        <div className="p-24 max-w-2xl">
          ...
          <Typography className="mb-16" component="div">
            ...
            provides content and actions related to the current screen. It’s used for branding,
          ...
          <Typography className="mb-16" component="div">
            <FuseExample
              ...
              iframe={false}
              component={
                require('app/main/documentation/material-ui-components/components/app-bar/SimpleAppBar.js')
                  .default
              }
          ...
          <ol>
            <li>
              ...
              <ul>
                <li>
                  <code>{`options.disableHysteresis`}</code> (<em>Boolean</em> [optional]): Defaults
                  to <code>{`false`}</code>. Disable the hysteresis. Ignore the scroll direction
                  when determining the <code>{`trigger`}</code> value.
                </li>
                <li>
                ...
                <li>
                  ...
                  <code>{`100`}</code>. Change the <code>{`trigger`}</code> value when the vertical
                  scroll strictly crosses this threshold (exclusive).
                </li>
              </ul>
            </li>
          </ol>
