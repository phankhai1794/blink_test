      ...
      content={
        <div className="p-24 max-w-2xl">
          ...
          <Typography className="mb-16" component="div">
            <a href="https://material.io/design/components/dividers.html">Dividers</a> separate
          ...
          <Typography className="mb-16" component="div">
            The divider renders as a <code>{`&lt;hr&gt;`}</code> by default. You can save rendering
            this DOM element by using the <code>{`divider`}</code> property on the{' '}
          ...
          <Typography className="mb-16" component="div">
            We need to make sure the <code>{`Divider`}</code> is rendered as a <code>{`li`}</code>{' '}
            to match the HTML5 specification. The examples below show two ways of achieving this.
          </Typography>
          <Typography className="text-32 mt-32 mb-8" component="h2">
            Inset Dividers
          </Typography>
