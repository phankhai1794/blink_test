      ...
      content={
        <div className="p-24 max-w-2xl">
          ...
          <Typography className="mb-16" component="div">
            ...
            are the preferred way to adjust settings on mobile. The option that the switch controls,
          ...
          <Typography className="mb-16" component="div">
            <code>{`Switch`}</code> can also be used with a label description thanks to the{' '}
          ...
          <Typography className="mb-16" component="div">
            ...
            components that provides an easier API. However, we encourage you to use a{' '}
            <a href="#checkboxes">Checkbox</a> instead.
          </Typography>
          <Typography className="mb-16" component="div">
            <FuseExample
              className="my-24"
          ...
          <Typography className="mb-16" component="div">
            ...
            switches. In most cases, this is done by using the <code>{`&lt;label&gt;`}</code>{' '}
            element (<a href="/api/form-control-label/">FormControlLabel</a>).
          </Typography>
          <Typography className="mb-16" component="div">
            ...
            via the <code>{`inputProps`}</code> property.
          </Typography>
