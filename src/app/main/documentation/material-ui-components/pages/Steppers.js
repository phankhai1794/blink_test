      ...
      content={
        <div className="p-24 max-w-2xl">
          ...
          <Typography className="mb-16" component="div">
            ...
            display progress through a sequence of logical and numbered steps. They may also be used
            for navigation. Steppers may display a transient feedback message after a step is saved.
          </Typography>
          <Typography className="mb-16" component="div">
            <strong>Types of Steps</strong>
          </Typography>
          <ul>
            <li>Editable</li>
            <li>Non-editable</li>
          ...
          <Typography className="mb-16" component="div">
            <strong>Types of Steppers</strong>
          </Typography>
          <ul>
            <li>Horizontal</li>
            <li>Vertical</li>
          ...
          <blockquote>
            <Typography className="mb-16" component="div">
              <strong>Note:</strong> Steppers are no longer documented in the Material Design
              documentation.
            </Typography>
          </blockquote>
          ...
          <Typography className="mb-16" component="div">
            The <code>{`Stepper`}</code> can be controlled by passing the current step index
            (zero-based) as the <code>{`activeStep`}</code> property. <code>{`Stepper`}</code>{' '}
            orientation is set using the <code>{`orientation`}</code> property.
          </Typography>
          <Typography className="mb-16" component="div">
            This example also shows the use of an optional step by placing the{' '}
            <code>{`optional`}</code> property on the second <code>{`Step`}</code> component. Note
            that it&#39;s up to you to manage when an optional step is skipped. Once you&#39;ve
            determined this for a particular step you must set <code>{`completed={false}`}</code> to
            signify that even though the active step index has gone beyond the optional step,
          ...
          <Typography className="mb-16" component="div">
            ...
            automatically set to <code>{`disabled={true}`}</code> based on the{' '}
            <code>{`activeStep`}</code> property.
          </Typography>
          <Typography className="mb-16" component="div">
            We&#39;ve used the <code>{`StepButton`}</code> here to demonstrate clickable step labels
            as well as setting the <code>{`completed`}</code>
            flag however because steps can be accessed in a non-linear fashion it&#39;s up to your
            own implementation to determine when all steps are completed (or even if they need to be
            completed).
          </Typography>
          <Typography className="mb-16" component="div">
            <FuseExample
          ...
          <Typography className="mb-16" component="div">
            ...
            <code>{`alternativeLabel`}</code> property on the <code>{`Stepper`}</code> component.
          </Typography>
          <Typography className="mb-16" component="div">
            <FuseExample
              className="my-24"
          ...
          <Typography className="mb-16" component="div">
            This component uses a customized <code>{`StepConnector`}</code> element that changes
            border color based on the <code>{`active`}</code> and <code>{`completed`}</code> state.
          </Typography>
          <Typography className="mb-16" component="div">
            <FuseExample
              className="my-24"
