      ...
      content={
        <div className="p-24 max-w-2xl">
          ...
          <Typography className="description">
            The portal component renders its children into a new "subtree" outside of current
            component hierarchy.
          </Typography>
          ...
          <Typography className="mb-16" component="div">
            The component is used internally by the{' '}
            ...
            components. On the server, the content won&#39;t be rendered. You have to wait for the
            client side hydratation to see the children.
          </Typography>
