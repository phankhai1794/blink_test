    ...
    <FusePageSimple
      ...
      content={
        <div className="p-24 max-w-2xl">
          ...
          <Typography className="mb-16" component="div">
            A fluid container width is bounded by that <code>{`maxWidth`}</code> property value.
          </Typography>
...
`}
          ...
          <Typography className="mb-16" component="div">
            If you prefer to design for a fixed set of sizes instead of trying to accommodate a
            fully fluid viewport, you can set the <code>{`fixed`}</code> property. The max-width
            matches the min-width of the current breakpoint.
          </Typography>
