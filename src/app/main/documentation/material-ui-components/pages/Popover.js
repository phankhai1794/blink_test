      ...
      content={
        <div className="p-24 max-w-2xl">
          ...
          <Typography className="mb-16" component="div">
            ...
            <code>{`anchorEl`}</code>. When it is <code>{`anchorPosition`}</code>, the component
            will, instead of <code>{`anchorEl`}</code>, refer to the <code>{`anchorPosition`}</code>{' '}
          ...
          <Typography className="mb-16" component="div">
            We demonstrate how to use the <code>{`Popover`}</code> component to implement a popover
