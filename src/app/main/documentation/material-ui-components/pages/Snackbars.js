      ...
      content={
        <div className="p-24 max-w-2xl">
          ...
          <Typography className="description">
            Snackbars provide brief messages about app processes - typically at the bottom of the
            screen.
          </Typography>

          <Typography className="mb-16" component="div">
            <a href="https://material.io/design/components/snackbars.html">Snackbars</a> inform
            users of a process that an app has performed or will perform. They appear temporarily,
            towards the bottom of the screen. They shouldn’t interrupt the user experience, and they
          ...
          <Typography className="mb-16" component="div">
            <a href="/components/transitions/#grow">Grow</a> is the default transition but you can
            use a different one.
          </Typography>
          <Typography className="mb-16" component="div">
            <FuseExample
          ...
          <Typography className="mb-16" component="div">
            ...
            <a href="https://github.com/iamhosseindhv/notistack">notistack</a>. notistack makes it
            easy to display snackbars (so you don&#39;t have to deal with open/close state of them).
            It also enables you to stack them on top of one another (but discouraged by the
            specification).
          </Typography>
          <Typography className="mb-16" component="div">
            <FuseExample
