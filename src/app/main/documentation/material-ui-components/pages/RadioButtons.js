    ...
    <FusePageSimple
      ...
      content={
        <div className="p-24 max-w-2xl">
          ...
          <Typography className="mb-16" component="div">
            <code>{`RadioGroup`}</code> is a helpful wrapper used to group <code>{`Radio`}</code>{' '}
          ...
          <Typography className="mb-16" component="div">
            <code>{`Radio`}</code> can also be used standalone, without the wrapper.
          </Typography>
          <Typography className="mb-16" component="div">
            <FuseExample
              className="my-24"
          ...
          <Typography className="mb-16" component="div">
            <FuseExample
              ...
              iframe={false}
              component={
                require('app/main/documentation/material-ui-components/components/radio-buttons/FormControlLabelPosition.js')
                  .default
              }
