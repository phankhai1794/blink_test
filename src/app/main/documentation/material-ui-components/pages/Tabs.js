      ...
      content={
        <div className="p-24 max-w-2xl">
          ...
          <Typography className="mb-16" component="div">
            ...
            navigation between groups of content that are related and at the same level of
            hierarchy.
          </Typography>
          ...
          <Typography className="mb-16" component="div">
            Long labels will automatically wrap on tabs. If the label is too long for the tab, it
            will overflow and the text will not be visible.
          </Typography>
          <Typography className="mb-16" component="div">
            <FuseExample
              className="my-24"
          ...
          <Typography className="mb-16" component="div">
            Fixed tabs should be used with a limited number of tabs and when consistent placement
          ...
          <Typography className="mb-16" component="div">
            The <code>{`variant=&quot;fullWidth&quot;`}</code> property should be used for smaller
          ...
          <Typography className="mb-16" component="div">
            ...
            <a href="https://mui-treasury.com/components/tabs">
          ...
          <Typography className="mb-16" component="div">
            By default tabs use a <code>{`button`}</code> element, but you can provide your own
            custom tag or component. Here&#39;s an example of implementing tabbed navigation:
          </Typography>
          <Typography className="mb-16" component="div">
            <FuseExample
              className="my-24"
