    ...
    <FusePageSimple
      ...
      content={
        <div className="p-24 max-w-2xl">
          ...
          <Typography className="mb-16" component="div">
            The ButtonGroup component can be used to group outlined (the default) or contained
            buttons.
          </Typography>
          <Typography className="mb-16" component="div">
            <FuseExample
              ...
              iframe={false}
              component={
                require('app/main/documentation/material-ui-components/components/buttons/GroupedButtons.js')
                  .default
              }
          ...
          <Typography className="mb-16" component="div">
            ButtonGroup can also be used to create a split button. The dropdown can change the
            button action (as in this example), or be use to immediately trigger a related action.
          </Typography>
          <Typography className="mb-16" component="div">
            <FuseExample
              className="my-24"
              iframe={false}
              component={
                require('app/main/documentation/material-ui-components/components/buttons/SplitButton.js')
                  .default
              }
          ...
          <Typography className="mb-16" component="div">
            ...
            (FAB) performs the primary, or most common, action on a screen. It appears in front of
            all screen content, typically as a circular shape with an icon in its center. FABs come
            in two types: regular, and extended.
          </Typography>
          <Typography className="mb-16" component="div">
          ...
          <Typography className="mb-16" component="div">
            <FuseExample
              ...
              iframe={false}
              component={
                require('app/main/documentation/material-ui-components/components/buttons/FloatingActionButtons.js')
                  .default
              }
          ...
          <Typography className="mb-16" component="div">
            ...
            entering animations are triggered at the same time, we use <code>{`enterDelay`}</code>{' '}
            to allow the outgoing Floating Action Button&#39;s animation to finish before the new
            one enters.
          </Typography>
          <Typography className="mb-16" component="div">
            <FuseExample
              ...
              iframe={false}
              component={
                require('app/main/documentation/material-ui-components/components/buttons/FloatingActionButtonZoom.js')
                  .default
              }
          ...
          <Typography className="mb-16" component="div">
            ...
            <a href="https://mui-treasury.com/components/button">
          ...
          <Typography className="mb-16" component="div">
            ...
            on top of the same component: the <code>{`ButtonBase`}</code>. You can take advantage of
            this lower level component to build custom interactions.
          </Typography>
          <Typography className="mb-16" component="div">
            <FuseExample
              className="my-24"
              iframe={false}
              component={
                require('app/main/documentation/material-ui-components/components/buttons/ButtonBases.js')
                  .default
              }
          ...
          <Typography className="mb-16" component="div">
            One common use case is to use the button to trigger a navigation to a new page. The{' '}
            <code>{`ButtonBase`}</code> component provides a property to handle this use case:{' '}
            <code>{`component`}</code>. However for certain focus polyfills{' '}
            <code>{`ButtonBase`}</code> requires the DOM node of the provided component. This is
            achieved by attaching a ref to the component and expecting that the component forwards
            this ref to the underlying DOM node. Given that a lot of our interactive components rely
            on <code>{`ButtonBase`}</code>, you should be able to take advantage of it everywhere:
          </Typography>
          <Typography className="mb-16" component="div">
            <FuseExample
              className="my-24"
              iframe={false}
              component={
                require('app/main/documentation/material-ui-components/components/buttons/ButtonRouter.js')
                  .default
              }
          ...
          <Typography className="mb-16" component="div">
            <em>
              Note: Creating the Button components is necessary to prevent unexpected unmounting.
              You can read more about it in our{' '}
              <a href="/guides/composition/#component-property">component property guide</a>.
            </em>
          </Typography>
        </div>
      }
