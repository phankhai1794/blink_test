      ...
      content={
        <div className="p-24 max-w-2xl">
          <Typography className="mb-16" component="p">
            The Fuse React uses material-ui's theming by default. You can can change the colors, the
            typography with defining theme configuration objects.
          </Typography>
          ...
          <Typography className="mb-16" component="p">
            Theme configurations are located at <code>src/app/fuse-configs/themesConfig.js</code>{' '}
            file.
          </Typography>
