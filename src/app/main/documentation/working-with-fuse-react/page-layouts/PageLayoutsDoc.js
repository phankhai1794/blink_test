    ...
    <FusePageSimple
      ...
      content={
        <div className="p-24 max-w-2xl">
          ...
          <Typography className="mb-16" component="p">
            Every single app, pre-built page and even this documentation page uses the Fuse React's
          ...
          <Typography className="mb-16" component="p">
            Because page layout components, it's very easy to replicate any page style that you can
            find in Fuse React.
          </Typography>
