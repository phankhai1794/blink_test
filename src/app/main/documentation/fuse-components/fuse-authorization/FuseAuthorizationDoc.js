      ...
      content={
        <div className="p-24 max-w-2xl">
          <Typography className="mb-16" component="p">
            ...
            restricts the unauthorized user access with looking <b>route configs</b> and{' '}
            <b>user.role</b>.
          </Typography>
          ...
          <Typography className="mb-16" component="p">
            You need to define authorization (auth) in the <b>route config files</b> for to control
            the access via permission roles.
          </Typography>
          ...
          <Typography className="my-16" component="p">
            You can also give different auth values for individual routes with writing auth value
          ...
          <Typography className="mb-16" component="p">
            You can control the navigation <b>item/group/collapse</b> visibility by adding{' '}
            <b>auth</b> property in <code>src/app/fuse-configs/NavigationConfig.js</code>.
          </Typography>
          ...
          <Typography className="mb-16" component="p">
            ...
            <br />
            With this configuration below, makes <b>whole app</b> auth protected:
          </Typography>
