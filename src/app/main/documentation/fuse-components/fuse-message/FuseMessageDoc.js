      ...
      content={
        <div className="p-24 max-w-2xl">
          <Typography className="mb-16" component="p">
            <code>FuseMessage</code> is a simple snackbar trigger for easily showing messages via
          ...
          <Typography className="mb-16" component="p">
            You can show messages anywhere with dispatching the action showMessage, its using
