      ...
      content={
        <div className="p-24 max-w-2xl">
          <Typography className="mb-16" component="p">
            <code>FuseLayout</code> is the main layout component of the Fuse React. It allows to
            switch theme layouts, set layout settings based on default configuration and route
            configs.
          </Typography>
          ...
          <Typography className="mb-16" component="p">
            ...
            <Link
              ...
              to="/documentation/working-with-fuse-react/theme-layouts"
            >
              Theme Layouts
            </Link>
            at documentation.
