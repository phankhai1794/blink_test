      ...
      content={
        <div className="p-24 max-w-2xl">
          <Typography className="mb-16" component="p">
            <code>FuseDialog</code> is a simple dialog trigger for easily showing dialog messages
            via redux action. It should be located in the theme layouts.
          </Typography>
          ...
          <Typography className="mb-16" component="p">
            You can show dialog anywhere with dispatching the action openDialog, its using
