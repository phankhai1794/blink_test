      ...
      content={
        <div className="p-24 max-w-2xl">
          <Typography className="mb-16" component="p">
            <code>FuseNavigation</code> is a custom built Fuse component allows you to create a
          ...
          <Typography className="mb-16" component="p">
            <code>FuseNavigation</code> uses a array to populate the entire navigation. It supports
          ...
          <Typography className="mt-32 p-8 rounded-4 bg-yellow-lightest border-1 border-yellow-dark text-black mb-8">
          ...
          <Typography className="text-16 mb-8" component="h2">
            When true, the active class/style will only be applied if the location is matched
            exactly.
          </Typography>
          <FuseHighlight component="pre" className="language-json">
            {`
          ...
          <Typography className="text-16 mb-8" component="h2">
            Use <code>setNavigation(navigation{'<Array>'})</code> action to set/change whole
            navigation.
          </Typography>
          ...
          <div className="border-1 rounded-8 p-16 my-16">
            <Typography className="text-16 mb-24" component="h2">
              With the button below, "fusetheme.com" navigation item is added into top of the
              "Dashboards" children.
            </Typography>
