...
function FuseSettings(props)
{
    ...
    function handleChange(event)
    {
        ...
        const newSettings = _.set(_.merge(settings, event.target.name === 'theme.main' ? syncTheme(event.target.value) : {}), event.target.name , event.target.type === 'checkbox' ? event.target.checked : event.target.value);
